...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RRD    0x00000005UL
    /* CFG_RRD                           [0:32]  RW value= 0x5 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RFC    0x000000EAUL
    /* CFG_RFC                           [0:32]  RW value= 0xEA */
#endif
