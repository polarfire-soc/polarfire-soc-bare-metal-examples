 ...
 * These settings are non default in the MSS Configurator
 * The have been updated in the MSS Configurator UI.
 */
//On the tab DDR Controller, 3 => ODT DQ == 80, 6 => ODT DQ == 40,
