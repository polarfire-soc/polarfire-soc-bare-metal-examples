...
#define LIBERO_SETTING_CONFIGURED_PERIPHERALS    0x00000800UL
    ...
    /* UART0                             [8:1]   RW value= 0x0 */
    /* UART1                             [9:1]   RW value= 0x0 */
    /* UART2                             [10:1]  RW value= 0x0 */
    /* UART3                             [11:1]  RW value= 0x1 */
    /* UART4                             [12:1]  RW value= 0x0 */
