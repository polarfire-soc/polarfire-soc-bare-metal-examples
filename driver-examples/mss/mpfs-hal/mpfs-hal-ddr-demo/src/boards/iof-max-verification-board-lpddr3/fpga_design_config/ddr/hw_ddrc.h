...
#define LIBERO_SETTING_CFG_MANUAL_ADDRESS_MAP    0x00000001UL
    /* CFG_MANUAL_ADDRESS_MAP            [0:32]  RW value= 0x1 */ 
#endif
...
/*IP Blk = ADDR_MAP Access=RW */ 
#define LIBERO_SETTING_CFG_BANKADDR_MAP_0    0x0001B699UL
    /* CFG_BANKADDR_MAP_0                [0:32]  RW value= 0x01B699 */ 
#endif
...
/*IP Blk = ADDR_MAP Access=RW */ 
#define LIBERO_SETTING_CFG_ROWADDR_MAP_0    0xCE34C2CAUL
    /* CFG_ROWADDR_MAP_0                 [0:32]  RW value= 0xCE34C2CA */ 
#endif
#if !defined (LIBERO_SETTING_CFG_ROWADDR_MAP_1)
/*IP Blk = ADDR_MAP Access=RW */ 
#define LIBERO_SETTING_CFG_ROWADDR_MAP_1    0x44D24503UL
    /* CFG_ROWADDR_MAP_1                 [0:32]  RW value= 0x44D24503 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_ROWADDR_MAP_2)
/*IP Blk = ADDR_MAP Access=RW */ 
#define LIBERO_SETTING_CFG_ROWADDR_MAP_2    0x0185D655UL
    /* CFG_ROWADDR_MAP_2                 [0:32]  RW value= 0x0185D655 */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_BL    0x00000002UL
    /* CFG_BL                            [0:32]  RW value= 0x2 */ 
#endif
...
#define LIBERO_SETTING_CFG_RRD    0x00000007UL
    /* CFG_RRD                           [0:32]  RW value= 0x7 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_RP)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_RP    0x0000000EUL
    /* CFG_RP                            [0:32]  RW value= 0xE */ 
#endif
#if !defined (LIBERO_SETTING_CFG_RC)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_RC    0x0000002AUL
    /* CFG_RC                            [0:32]  RW value= 0x2A */ 
#endif
#if !defined (LIBERO_SETTING_CFG_FAW)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_FAW    0x00000022UL
    /* CFG_FAW                           [0:32]  RW value= 0x22 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_RFC)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_RFC    0x0000008CUL
    /* CFG_RFC                           [0:32]  RW value= 0x8C */ 
#endif
...
#define LIBERO_SETTING_CFG_READ_TO_WRITE    0x00000006UL
    /* CFG_READ_TO_WRITE                 [0:32]  RW value= 0x6 */ 
#endif
...
#define LIBERO_SETTING_CFG_READ_TO_WRITE_ODT    0x00000006UL
    /* CFG_READ_TO_WRITE_ODT             [0:32]  RW value= 0x6 */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_DS    0x00000002UL
    /* CFG_DS                            [0:32]  RW value= 0x2 */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_REF_PER    0x00000A26UL
    /* CFG_REF_PER                       [0:32]  RW value= 0xA26 */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_MEMORY_TYPE    0x00000100UL
    /* CFG_MEMORY_TYPE                   [0:32]  RW value= 0x100 */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_INIT_DURATION    0x00001A04UL
    /* CFG_INIT_DURATION                 [0:32]  RW value= 0x1A04 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_ZQINIT_CAL_DURATION)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_ZQINIT_CAL_DURATION    0x0000029AUL
    /* CFG_ZQINIT_CAL_DURATION           [0:32]  RW value= 0x29A */ 
#endif
#if !defined (LIBERO_SETTING_CFG_ZQ_CAL_L_DURATION)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_ZQ_CAL_L_DURATION    0x000000F0UL
    /* CFG_ZQ_CAL_L_DURATION             [0:32]  RW value= 0xF0 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_ZQ_CAL_S_DURATION)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_ZQ_CAL_S_DURATION    0x0000003CUL
    /* CFG_ZQ_CAL_S_DURATION             [0:32]  RW value= 0x3C */ 
#endif
...
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_MRR    0x00000004UL
    /* CFG_MRR                           [0:32]  RW value= 0x4 */ 
#endif
...
#define LIBERO_SETTING_CFG_ODT_POWERDOWN    0x00000000UL
    /* CFG_ODT_POWERDOWN                 [0:32]  RW value= 0x0 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_WL)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_WL    0x00000006UL
    /* CFG_WL                            [0:32]  RW value= 0x6 */ 
#endif
#if !defined (LIBERO_SETTING_CFG_RL)
/*IP Blk = MC_BASE2 Access=RW */ 
#define LIBERO_SETTING_CFG_RL    0x0000000AUL
