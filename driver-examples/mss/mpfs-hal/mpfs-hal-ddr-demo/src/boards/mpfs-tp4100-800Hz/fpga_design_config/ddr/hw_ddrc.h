...
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_CA_PARITY_ERR_STATUS    0x00000001UL
    /* CFG_CA_PARITY_ERR_STATUS          [0:32]  RW value= 0x1 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RC    0x00000028UL
    /* CFG_RC                            [0:32]  RW value= 0x28 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_CWL    0x0000000CUL
    /* CFG_CWL                           [0:32]  RW value= 0xC */
#endif
...
#define LIBERO_SETTING_CFG_PARITY_RDIMM_DELAY    0x00000001UL
    /* CFG_PARITY_RDIMM_DELAY            [0:32]  RW value= 0x1 */
#endif
