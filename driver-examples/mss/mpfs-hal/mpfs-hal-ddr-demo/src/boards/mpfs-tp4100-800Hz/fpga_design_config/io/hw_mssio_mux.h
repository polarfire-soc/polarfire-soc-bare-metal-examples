...
*/
#define LIBERO_SETTING_IOMUX0_CR    0x00000002UL
...
#define LIBERO_SETTING_IOMUX1_CR    0xF0000000UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX3_CR    0xF5555FFFUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX4_CR    0xFFFF333FUL
    /* PAD22                             [0:4]   RW value= 0xF */
    /* PAD23                             [4:4]   RW value= 0x3 */
    /* PAD24                             [8:4]   RW value= 0x3 */
    /* PAD25                             [12:4]  RW value= 0x3 */
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_IOMUX5_CR    0x366FFFFFUL
    /* PAD30                             [0:4]   RW value= 0xF */
    /* PAD31                             [4:4]   RW value= 0xF */
    /* PAD32                             [8:4]   RW value= 0xF */
    /* PAD33                             [12:4]  RW value= 0xF */
    /* PAD34                             [16:4]  RW value= 0xF */
    /* PAD35                             [20:4]  RW value= 0x6 */
    /* PAD36                             [24:4]  RW value= 0x6 */
    /* PAD37                             [28:4]  RW value= 0x3 */
#endif
