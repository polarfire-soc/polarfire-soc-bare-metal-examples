...
extern const uint8_t msg_self_refresh_status_off[];
extern const uint8_t msg_ddr_pll_output_status_on[];
extern const uint8_t msg_ddr_pll_output_status_off[];
extern const uint8_t msg_state_mode_status_lp[];
extern const uint8_t msg_state_mode_status_hp[];
