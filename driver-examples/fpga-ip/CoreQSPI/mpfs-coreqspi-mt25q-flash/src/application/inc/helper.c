 ...
 * @brief Implementation of helper functions for UART terminal interactions.
 *
 */
...
)
{
    ...
    {
    	MSS_UART_polled_tx(g_uart, invalid_ms, sizeof( invalid_ms));
    }
}
...
)
{
    ...
    MSS_UART_polled_tx(g_uart, msg, msg_size);
