...
*/
#define LIBERO_SETTING_ALT_IOMUX0_CR    0x00003109UL
...
#define LIBERO_SETTING_ALT_IOMUX1_CR    0xF0000000UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX2_CR    0x00BBFFFFUL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX4_CR    0x77CC4444UL
...
(Equivalent to Tristate),0xB implies GPIO ,0xC implies Fabric-test,0xD implies
Logic 0,0xE implies Logic 1, 0xF implies Tristate */
#define LIBERO_SETTING_ALT_IOMUX5_CR    0xF55FF77FUL
...
/*IO electrical configuration for MSSIO pad */
#define LIBERO_SETTING_ALT_MSSIO_BANK4_IO_CFG_12_13_CR    0x09A80520UL
