...
#define LIBERO_SETTING_WAY_MASK_DMA    0x0000FF0FUL
...
scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for all
masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_AXI4_PORT_0    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for all
masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_AXI4_PORT_1    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for all
masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_AXI4_PORT_2    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
evict the way. */
#define LIBERO_SETTING_WAY_MASK_AXI4_PORT_3    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
#define LIBERO_SETTING_WAY_MASK_E51_DCACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
#define LIBERO_SETTING_WAY_MASK_E51_ICACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
for scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for
all masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_1_DCACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
for scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for
all masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_1_ICACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
WAY_MASK_1 and WAY_MASK_2 will be set to zero for all masters, so they can not
evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_2_DCACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
for scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for
all masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_2_ICACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
WAY_MASK_1 and WAY_MASK_2 will be set to zero for all masters, so they can not
evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_3_DCACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
for scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for
all masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_3_ICACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
WAY_MASK_1 and WAY_MASK_2 will be set to zero for all masters, so they can not
evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_4_DCACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
...
for scratchpad, WAY_MASK_0, WAY_MASK_1 and WAY_MASK_2 will be set to zero for
all masters, so they can not evict the way. */
#define LIBERO_SETTING_WAY_MASK_U54_4_ICACHE    0x0000FF0FUL
    /* WAY_MASK_0                        [0:1]   RW value= 0x1 */
    /* WAY_MASK_1                        [1:1]   RW value= 0x1 */
    /* WAY_MASK_2                        [2:1]   RW value= 0x1 */
    /* WAY_MASK_3                        [3:1]   RW value= 0x1 */
