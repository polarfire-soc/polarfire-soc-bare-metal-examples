...
/* (Generated value from configurator v2022.1 is 2) */
#define LIBERO_SETTING_RPC_ODT_ADDCMD       0x00000005UL
/* (Generated value from configurator v2022.1 is    0x0004C422UL) */
#define LIBERO_SETTING_DPC_BITS             0x0004C432UL
    /* DPC_VS                            [0:4]   RW value= 0x2 */
    /* DPC_VRGEN_H                       [4:6]   RW value= 0x3 */
